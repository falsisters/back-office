...
export const EditCashierSchema = z.object({
  ...
  accessKey: z.string().length(4, "Access key must be exactly 4 characters").optional(),
  permissions: z.array(CashierPermissionsEnum).min(1, "At least one permission is required").optional(),
});
