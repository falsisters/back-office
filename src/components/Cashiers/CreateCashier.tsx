  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] shadow-xl border-t-4 border-t-secondary">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-primary">Create New Cashier</DialogTitle>
          <DialogDescription>Add a new cashier with custom permissions</DialogDescription>
        </DialogHeader>
