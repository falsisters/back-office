...
import type { SackType, SackPrice, SpecialPrice } from "../../../utils/types/schema.type"
...
export default function EditProduct({ productId, onProductUpdated }: EditProductProps) {
  ...
  const loadProduct = useCallback(async () => {
    ...
    try {
      ...
      if (result.data) {
        ...
        const sackPriceArray = Array.isArray(fetchedProduct.SackPrice) ? fetchedProduct.SackPrice : []
  ...
  return (
    ...
    >
      ...
      <div className="max-h-[85vh] overflow-y-auto p-6">
        <DialogHeader>
          <DialogTitle className="text-xl text-primary font-bold">Edit Product</DialogTitle>
        </DialogHeader>
        ...
        {isLoading ? (
          ...
          <div className="py-4 text-center text-muted-foreground">Failed to load product data</div>
        )}
        </div>
      </DialogContent>
    </Dialog>
