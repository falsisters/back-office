            ...
            {detailedDelivery && (
              <>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    <p>
                      <strong>Total:</strong> ${detailedDelivery.total.toFixed(2)}
                    </p>
                    <p>
                  ...
                  <div>
                    ...
                    <p>
                      <strong>Created:</strong> {new Date(detailedDelivery.createdAt).toLocaleString()}
                    </p>
                    {detailedDelivery.isFinished && detailedDelivery.timeFinished && (
                      <p>
                        <strong>Finished:</strong> {new Date(detailedDelivery.timeFinished).toLocaleString()}
                      </p>
                    )}
                  </div>
                </div>
                ...
                {detailedDelivery.attachments && detailedDelivery.attachments.length > 0 && (
                  <div className="mt-4">
                    <h3 className="font-semibold mb-2">Attachments:</h3>
                    <ul className="list-disc list-inside">
                      {detailedDelivery.attachments.map((attachment, index) => (
                        <li key={index}>
                          <a
                            href={attachment}
                            target="_blank"
