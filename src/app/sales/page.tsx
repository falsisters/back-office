...
export default function SalesReportPage() {
  ...
  // In a real application, you would calculate this based on the actual cost of goods sold
  const mockProfit = totalSales * 0.2 // Assuming 20% profit margin for this example
